...
### Extract survey data
```{r extract.survey}
FactCovars = c("healthCode","appVersion","phoneInfo","are-caretaker","deep-brain-stimulation","diagnosis-year","education","employment","gender","maritalStatus","professional-diagnosis","race","smartphone","smoked","surgery")
ContCovars = c("years-smoking", "age")
...
TBL_File <- File('./Phonation_Features_Metadata.tsv',name = 'Phonation Feature Extraction and Quality Control Data',parentId = parentId)
...
|  *Results*           |  *SynapseID*                  |
|  -------             |   ---------                   |
|  Extracted Features  |  `r paste(TBL_OBJ@schema@properties@properties@stringAnnotations$id,TBL_OBJ@schema@properties@properties@stringAnnotations$versionLabel,sep='.')` |